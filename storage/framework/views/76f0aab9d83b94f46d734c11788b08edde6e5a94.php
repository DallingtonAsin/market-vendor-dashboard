      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="<?php echo e(route('users.index')); ?>"><i class="fa fa-list"></i> List of vendors</a></li>
          </ul>
        </li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo e(route('clients.index')); ?>"><i class="fa fa-list"></i> Submited Lists</a></li>
