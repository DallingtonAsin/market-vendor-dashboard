...
<div id="example2_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
  ...
  <script src="<?php echo e(asset('customers/notify/notify.js')); ?>"></script>
  <script>
  ...
  <script>
    ...
    const ajaxUrl =   <?php echo json_encode(route('customers.ajax.fetch'), 15, 512) ?>;
    const cat = 'customers';
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/mkv-ms/resources/views/livewire/customers/index.blade.php ENDPATH**/ ?>