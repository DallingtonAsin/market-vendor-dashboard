<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1 style="font-weight:bolder; text-transform:uppercase; font-family: 'Times New Roman', Times, serif">
       Income Monthly Review
      </h1>
      <ol class="breadcrumb">
        <!-- li><a href="#"><i class="fa fa-dashboard"></i> Level</a></li-->
        <li class="active">Income Monthly Review</li>
      </ol>
    </section>
    ...
    <div class="box-header">
      <div class="row">
        <div class="col-sm-4">
          ...
          font-family: 'Times New Roman', Times, serif">Income Monthly Review</h3>
        </div>
  </div>
</div>
...
<script>
    ...
    const ajaxUrl =   <?php echo json_encode(route('income.monthly.ajax.fetch'), 15, 512) ?>;
...
</script><?php /**PATH C:\laragon\www\parkpro-dashboard\resources\views/livewire/reports/income-monthly-review.blade.php ENDPATH**/ ?>