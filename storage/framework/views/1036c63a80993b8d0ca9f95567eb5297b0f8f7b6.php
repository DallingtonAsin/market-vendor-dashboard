...
<div id="example2_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
  ...
  <script>
    ...
    const ajaxUrl =   <?php echo json_encode(route('pending.requests.fetch'), 15, 512) ?>;
    const cat = 'pending request';
    const token = "<?php echo e(csrf_token()); ?>";
    const approveSeletectedUrl = <?php echo json_encode(route('requests.pending.approve'), 15, 512) ?>;
...
<?php /**PATH C:\laragon\www\parkpro-dashboard\resources\views/livewire/requests/pending.blade.php ENDPATH**/ ?>