<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1 style="font-weight:bolder; text-transform:uppercase; font-family: 'Times New Roman', Times, serif">
        Vendor Goods  Mangement
      </h1>
      <ol class="breadcrumb">
        <!-- li><a href="#"><i class="fa fa-dashboard"></i> Level</a></li-->
        <li class="active">Vendor Goods Mangement</li>
      </ol>
    </section>
    ...
    <div class="box-header">
      <div class="row">
        <div class="col-sm-4">
          ...
          font-family: 'Times New Roman', Times, serif">List of market goods</h3>
            <span class="pl-0 mt-4 response"></span>
        </div>
        
     
      <div class="col-sm-4">
        <a type="button" href=<?php echo e(route('goods.add')); ?> class="btn btn-info pull-right">
        <i class="fa fa-plus-circle"></i> Add good
      </a>
    </div>
  </div>
...
<div id="example2_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
  ...
  <script>
    ...
    const ajaxUrl =   <?php echo json_encode(route('goods.ajax.fetch'), 15, 512) ?>;
    const cat = 'goods';
...
<?php /**PATH C:\laragon\www\mkv-ms\resources\views/livewire/goods/index.blade.php ENDPATH**/ ?>