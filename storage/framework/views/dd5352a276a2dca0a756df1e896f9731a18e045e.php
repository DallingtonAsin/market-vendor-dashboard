<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      Shopping Lists Mangement
      </h1>
      <ol class="breadcrumb">
        <!-- li><a href="#"><i class="fa fa-dashboard"></i> Level</a></li-->
        <li class="active">Shopping Lists Mangement</li>
      </ol>
    </section>
    ...
    <div class="box-header">
      <div class="row">
        <div class="col-sm-4">
          ...
          font-family: 'Times New Roman', Times, serif">List of shopping lists</h3>
...
<div id="example2_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
  ...
  <script>
    ...
    const ajaxUrl =   <?php echo json_encode(route('shopping.lists.fetch'), 15, 512) ?>;
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/mkv-ms/resources/views/livewire/shopping-lists/index.blade.php ENDPATH**/ ?>