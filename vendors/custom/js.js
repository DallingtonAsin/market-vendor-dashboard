            ...
            function makeDataTable2(table, title, columnArray, dataColumns) {
                ...
                oTable = $(table).dataTable({
                    ...
                    buttons: [
                        ...
                        function PendingTasksDataTable(table, title, columnArray, dataColumns) {
                            ...
                            oTable = $(table).dataTable({
                                ...
                                buttons: [
                                    ...
                                    $.extend(
                                        ...
                                        $.extend(
                                            ...
                                            $.extend(
                                                ...
                                                {
                                                    text: "<i></i> Mark Completed",
                                                    className: "btn btn-warning btn-sm btn-deselect-all",
                                                    action: function(e, dt, node, config) {
                                                        completeTask(table);
                                                    }
                                                }
                                    ...
                                    function CompletedTasksDataTable(table, title, columnArray, dataColumns) {
                                                ...
                                                $.extend(
                                                    ...
                                                    $.extend(
                                                        ...
                                                        $.extend(
                                                            ...
                                                            {
                                                                text: "<i></i> Approve Task",
                                                                className: "btn btn-success btn-sm btn-deselect-all",
                                                                action: function(e, dt, node, config) {
                                                                    approveTask(table);
                                                                }
                                                            }
                                                ...
                                                function completeTask(table) {
                                                    ...
                                                    if (arr.length > 0) {
                                                        $.confirm({
                                                            ...
                                                            closeIconClass: "fa fa-close text-danger",
                                                            title: "Complete "+cat,
                                                            content: "Are you sure you want to complete these "+cat+"",
                                                            buttons: {
                                                                confirm: function() {
                                                                    var self = this;
                                                                    return $.ajax({
                                                        ...
                                                        $.alert({
                                                            closeIcon: true,
                                                            title: "Information",
                                                            content: "Please select atleast one completed task"
                                                        });
                                                    }
                                                    console.log("Ids to delete", JSON.stringify(arr));
                                                ...
                                                function approveTask(table) {
                                                    ...
                                                    if (arr.length > 0) {
                                                        $.confirm({
                                                            ...
                                                            closeIconClass: "fa fa-close text-danger",
                                                            title: "Approve "+cat,
                                                            content: "Are you sure you want to approve these "+cat+"",
                                                            buttons: {
                                                                confirm: function() {
                                                                    var self = this;
                                                                    return $.ajax({
                                                        ...
                                                        $.alert({
                                                            closeIcon: true,
                                                            title: "Information",
                                                            content: "Please select atleast one task to be approved"
                                                        });
                                                    }
                                                    console.log("Ids to delete", JSON.stringify(arr));
