...
class ProcessedShoppingOrdersDataTable extends DataTable
{
    /**
    ...
    public function query(ShoppingOrder $model)
    {
            ...
            if($response->allowed()){
                $endPoint = '/shopping-orders/processed';
            }else{
                $endPoint = '/vendor/myorders/processed/'.Auth::user()->id;
            }
    ...
    {
        return 'ProcessedShoppingLists_' . date('YmdHis');
    }
}
